    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                com.example.foodmap.ValidateRequest validateRequest = new com.example.foodmap.ValidateRequest(UserEmail, responseListener);
        ...
        join_button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                        ...
                        try {
                            ...
                            if(UserPwd.equals(PassCk)) {
                                if (success) {
                                    ...
                                    Intent intent = new Intent(RegisterActivity.this, com.example.foodmap.LoginActivity.class);
                ...
                //서버로 Volley를 이용해서 요청
                com.example.foodmap.RegisterRequest registerRequest = new com.example.foodmap.RegisterRequest( UserEmail, UserPwd, UserName, responseListener);
                RequestQueue queue = Volley.newRequestQueue( RegisterActivity.this );
